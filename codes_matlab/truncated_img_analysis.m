...
if 1
    ...
    for i=1:numel(unique(y))
        ...
        histogram(X(idx,2),[0:0.05:1],'Normalization','probability');
    ...
    idx1 = find(y~=6);
    idx2 = find(y==6);
    histogram(X(idx1,2),[0:0.05:1],'Normalization','probability');
    histogram(X(idx2,2),[0:0.05:1],'Normalization','probability');
    xlabel('p_{edge}/p_{tot}');
